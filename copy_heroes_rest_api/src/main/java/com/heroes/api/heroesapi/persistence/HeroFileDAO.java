...
// this is where we put the database, for every method make a connection to the
// database,
// follow the wiki but define it in a method to have the connection
// tell allison to out data in
// have methof getConnection()
// For every entity have a dao
// dao i interface and file dao is its implementation
// create utility calss that has the sttaic metho get onnection
// then in the fil dao make instane of this connection connection conn =
// utilityclass.getCon()
// preparedStatememt = the object to ececute the query on to
// resiltset set - stmt. exectureQuery("query in SQL ")
// get connecton method is the wiki thing,ry is the ssh retireve teh conn obejct
@Component
public class HeroFileDAO implements HeroDAO {
     ...
     * <br>
     * If containsText is null, the array contains all of the {@linkplain Hero
     * heroes}
     * in the tree map
     * 
     * @return The array of {@link Hero heroes}, may be empty
    ...
    /**
     * Saves the {@linkplain Hero heroes} from the map into the file as an array of
     * JSON objects
     * 
